...
export function BlogPostCard({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="group flex flex-col bg-[#1a1a1a] rounded-2xl overflow-hidden border border-white/5 hover:border-[#bbff00]/25 transition-all duration-400 hover:-translate-y-1"
    >
      {/* Image */}
      ...
      <div className="flex flex-col flex-1 p-6 gap-3">
        <h2 className="font-display text-xl text-white leading-snug line-clamp-2 group-hover:text-[#bbff00] transition-colors duration-300">
          {title}
        </h2>
...
export function FeaturedPostCard({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="group relative flex flex-col md:flex-row rounded-3xl overflow-hidden border border-white/5 hover:border-[#bbff00]/20 transition-all duration-500 bg-[#1a1a1a] min-h-[380px] md:min-h-[420px]"
    >
      ...
      <div className="flex flex-col justify-between p-8 md:p-12 flex-1">
        ...
        <div className="flex items-end justify-between pt-6 mt-6 border-t border-white/8">
          <div>
