        ...
        <section className="bg-white py-16 px-6">
          <div className="max-w-3xl mx-auto prose prose-slate max-w-none">
            ...
            <p className="text-sm bg-amber-50 border border-amber-200 rounded-lg p-4 not-prose text-amber-800">
              <strong>Uwaga:</strong> Niniejszy regulamin dotyczy wyłącznie strony internetowej <strong>ourmoney.pl</strong> (landing page). Odrębny regulamin obowiązuje dla aplikacji dostępnej pod adresem app.ourmoney.pl.
            </p>
