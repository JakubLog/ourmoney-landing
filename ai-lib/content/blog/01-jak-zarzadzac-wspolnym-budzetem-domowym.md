...
- **seo.keywords:** wspólny budżet domowy, jak zarządzać wspólnym budżetem, budżet dla par, planowanie wydatków w związku, wspólne finanse
- **aiSeo.aiSummary:** Poradnik dla par o prowadzeniu wspólnego budżetu domowego w siedmiu krokach: spisanie dochodów, wyliczenie kosztów stałych, wybór modelu podziału wydatków, limity kategorii, pieniądze bez tłumaczenia dla każdej ze stron, nazwany cel oszczędnościowy i miesięczny przegląd budżetu.
- **aiSeo.keyTakeaways:**
  1. Budżet we dwoje zaczyna się od jednej liczby: sumy kosztów stałych, które i tak co miesiąc wychodzą z waszych kont.
  2. Model podziału wydatków ma być wybrany świadomie, a nie domyślnie po połowie.
  3. Limit na kategorię działa tylko wtedy, gdy oboje widzą stan wydatków w tym samym momencie.
  4. Piętnaście minut przeglądu raz w miesiącu wystarcza, żeby budżet nie rozjechał się z rzeczywistością.
- **cta.heading:** Prowadźcie budżet w jednym miejscu
- **cta.text:** OurMoney pokazuje obojgu ten sam budżet w czasie rzeczywistym. Bez arkuszy i bez pytania "ile jeszcze zostało".
- **cta.buttonLabel:** Wypróbuj za darmo
- **cta.buttonUrl:** https://app.ourmoney.pl

---

# Jak zarządzać wspólnym budżetem domowym? 7 kroków dla par
...
Popularne modele to podział równy, podział proporcjonalny do dochodów, wspólna pula plus osobne konta oraz rozliczanie kto za co płaci. Rozpisaliśmy je szczegółowo w tekście [Jak podzielić wydatki w związku? 4 niezawodne modele dla każdej pary](/pl/blog/jak-podzielic-wydatki-w-zwiazku-4-niezawodne-modele-dla-kazdej-pary). Jeśli chcecie od razu zobaczyć konkretne kwoty dla waszych zarobków, wpiszcie je w [kalkulator podziału wydatków](/pl/kalkulator).
...
Bez tego wspólny budżet zamienia się w kontrolę, a kontrola prędzej czy później kończy się ukrywaniem paragonów. Więcej o tym mechanizmie piszemy w tekście o [kłótniach o pieniądze w związku](/pl/blog/klotnie-o-pieniadze-w-zwiazku).
...
Wspólny budżet działa wtedy, gdy oboje widzicie te same liczby w tym samym momencie i gdy dodanie wydatku zajmuje kilka sekund. To jest dokładnie ten problem, który rozwiązuje [aplikacja do wspólnego budżetu](/pl/blog/aplikacja-do-wspolnego-budzetu-dla-par).
...
Jeśli chcecie pominąć etap arkusza, [OurMoney](https://app.ourmoney.pl) prowadzi ten budżet za was: wpisujecie dochody, wybieracie model podziału, a aplikacja pilnuje limitów i pokazuje obojgu ten sam stan konta na bieżąco. Założenie budżetu i zaproszenie partnera zajmuje dwie minuty i jest darmowe.
